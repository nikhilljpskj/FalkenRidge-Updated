  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          alert("Could not Subscribe at the moment. Please contact us via email or phone.");
  ...
  return (
    ...
    >
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Stay updated with the latest insights, trends, and exclusive offers—subscribe to our newsletter today!
      </p>
      <div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            type="hidden"
            name="message"
            value="its newsletter subscription"
          />
          <input
            type="submit"
            value="Subscribe"
