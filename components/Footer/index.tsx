      ...
      >
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-6/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link href="/" className="mb-8 inline-block">
                  <Image
                    src="/images/logo/FR logo-dark.png"
                    alt="logo"
                ...
                <div className="flex items-center">
                  ...
                  >
                    <svg
                      ...
                      className="fill-current"
                    >
                      <path d="M22.162 0H24l-9.212 10.564L24 24h-7.848l-5.852-7.028L4.59 24H0l9.947-11.42L0 0h7.993l5.37 6.596L19.476 0h2.686ZM17.713 21.76h2.072L6.082 2.158H3.864l13.849 19.602Z"/>
                    </svg>
                  </a>
                  <a
                    href="https://www.youtube.com/@FalkenRidge"
                  ...
                  <a
                    href="https://www.linkedin.com/company/falkenridge"
                    aria-label="social-link"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="https://operonx.com" target="blank"
                      className="dark:text-body-color-dark mb-4 inline-block text-base text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                    >
                      OperonX
                    </a>
          ...
          <p className="text-center text-base text-body-color dark:text-white">
            ...
            <a href="https://www.falkenridge.com" rel="nofollow noopener">
              FalkenRidge
            </a>
          </p>
          </div>
