            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="dark:text-body-color-dark mb-12 text-base !leading-relaxed text-body-color sm:text-lg md:text-xl">
                  At FalkenRidge, we harness cutting-edge technology and innovative solutions — from bespoke software development to scalable cloud services — to drive your business forward.
                </p>
